...
const ErrorHandler = ({ statusCode = 500, 
  title = "Server Error" }: IProps) => {
  const { pathname } = useLocation();

  return (
    <div className="fixed inset-0 flex items-center 
    justify-center p-5 w-full">
      <div className="text-center">
        <div className="inline-flex rounded-full bg-red-100 p-4">
          <div className="rounded-full stroke-red-600 bg-red-200 p-4">
            ...
            xmlns="http://www.w3.org/2000/svg">
              ...
              ></path>
              <path d="M17 16L22 21M22 16L17 21" strokeWidth="2" 
        ...
        <div className="flex items-center justify-center space-x-4 my-10">
          <Link
            to={"/"}
            className="inline-block bg-indigo-600 p-2 
